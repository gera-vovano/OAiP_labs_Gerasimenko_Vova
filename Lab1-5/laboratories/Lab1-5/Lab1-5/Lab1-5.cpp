...
int main() {
	...
	if (result == 1) {
		...
		else printf("нет решения или неверный формат вводимых данных \n");
	_getch();
	return 0;
}
/*
P.S. Подскажите, пожалуйста, что сделать, чтобы вычисления были правильными? 
Тоесть я ввожу 1 и по идее программа должна вывести констату, 
но выводит непонятние и огромные числа*/